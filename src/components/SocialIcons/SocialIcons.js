...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/jvasani" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        
        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/jigar64526" style={ { color: colorPrimary } }><i className="fab fa-facebook-f"></i></a>

        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/vasani-jigar-08802975/" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
